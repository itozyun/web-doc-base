 ...
 */
    ...
    if( p_Presto < 9.5 || // Presto 9.27 noscript 下のコンテンツが取れない, document.write でないと、コンテンツ量によって CSS が一部しか適用されない不具合に遭遇する
        p_Gecko  < 1.5 || // Gecko 1.4.1 noscript 下のコンテンツが取れない, Gecko 0.9.4 以下で確認 0.9.6 では発生しない document.write でないと css が適用されない
        ...
        p_ChromiumBase < 2 || // Windows XP + Chrome, noscript.textContent が ""
