...
(function(Va, Y, jb, Fc, O, ic, jd, Wb, qb, jc, kc, Gc, lc, r) {
  ...
  (function() {
    ...
    function ea(d) {
      ...
      (d = ia(u, Ba)) ? (D("[webFontTest] testWebFont mesurement success : " + d), I(d)) : qa(Ba) ? (D("[webFontTest] testWebFont timeout!"), Ia ? pa() : Fa ? I(0) : rb !== r ? ca(rb) : oc(ca)) : ba(ea);
    }
    function ia(d, v) {
      var q = 0, p = -1, k = [];
      if (!h) {
    ...
    var Fa = 9 > B, xa = 6 > za || J || 530 > ta || 5 > Ea, oa = "bad_" + eb() + "_", V = 5E3, N = 500, aa = "mmmmmmmmmmlliiiiiiiii", ma = 9 <= za && 18 > za || 3 > $a || 7 > Ea || ta && 0 >= Va.conpare(Za, "536.11"), a = ["monospace", "sans-serif", "serif"];
