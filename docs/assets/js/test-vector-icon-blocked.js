...
(function(Va, Y, ib, Fc, O, ic, jd, Wb, qb, jc, kc, Gc, lc, r) {
  ...
  (function() {
    ...
    sa = function(a, b, m, A, F) {
      b = oa(2, a, b, m, A, F);
      N || (a.appendChild(b), qa && null != A && L(b, A));
      return b;
    };
    Sb = function(a, b, m, A, F) {
      b = oa(0, a, b, m, A, F);
      N || (ca(a).insertBefore(b, a), qa && null != A && L(b, A));
      return b;
    };
    $c = function(a, b, m, A, F) {
      b = oa(1, a, b, m, A, F);
      var R;
      N || ((R = a.nextSibling) ? Ra(R).insertBefore(b, R) : Ra(a).appendChild(b), qa && null != A && L(b, A));
      return b;
    };
    ad = L;
    tc = function(a, b) {
  ...
  (function() {
    ...
    function ea(d) {
      ...
      (d = ia(u, Aa)) ? (D("[webFontTest] testWebFont mesurement success : " + d), I(d)) : pa(Aa) ? (D("[webFontTest] testWebFont timeout!"), Ia ? oa() : Fa ? I(0) : rb !== r ? ca(rb) : oc(ca)) : ba(ea);
    }
    function ia(d, v) {
      var q = 0, p = -1, k = [];
      if (!h) {
    ...
    function ca(d) {
      ...
      d ? (Ia = !0, Aa = N, D("[webFontTest] webFontTest_repeatToTestDataURIedCSSWebFont start!"), u = u.replace(na, ""), oa()) : I(0);
    }
    function oa() {
      if (w) {
        for (; w.length;) {
    ...
    var Fa = 9 > B, xa = 6 > Ea || J || 530 > ta || 5 > Da, na = "bad_" + db() + "_", V = 5E3, N = 500, aa = "mmmmmmmmmmlliiiiiiiii", qa = 21 > Ea || 7 > Da || ta && 0 >= Va.conpare(Za, "536.11"), a = ["monospace", "sans-serif", "serif"];
  ...
  (function() {
    ...
    if (Z && 0 > Va.conpare(Za, "0.9.5")) {
      ...
      var L = fb ? function(f) {
        16 === f.keyCode ? pa = !0 : 9 === f.keyCode && ca && na(ca, !0) && (ca.blur && ca.blur(), f.stopPropagation(), f.preventDefault(), ba(N));
      } : function(f) {
          ...
          if (nb(d, "prettyprint") && !nb(d, "prettyprinted")) {
            ...
            if (!v) {
              ...
              if (!q) {
                ...
                var k;
                !q && (k = oa(d)) && "CODE" === ab(k) && (q = h(k.className, "lang-") || h(k.className, "language-"));
              }
              p = ab(d);
