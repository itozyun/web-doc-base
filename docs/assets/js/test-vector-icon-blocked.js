...
var E, qb;
(function(Wa, Z, eb, Hc, M, mc, md, $b, rb, nc, oc, Ic, pc, v) {
  function ea(N) {
    if (Wa[0] === N) {
  ...
  function qc() {
    return 6 > y ? ra.scrollTop : y ? Ib.scrollTop : Z.pageYOffset;
  }
  var ra = M.body, fb = ra.style, Ib, zb, Ab, bb = Wa[1], y = ea(2) || ea(3), Jb = ea(7), kb = ea(5) || ea(6), D = ea(8) || ea(9), Y = ea(11) || ea(12), Vb = Y && 0 <= Wa.conpare(bb, "1.9.1"), Bb = ea(13), qa = ea(16), Fa = ea(17) || ea(18), Jc = ea(10) || ea(26), Ca = ea(21) || ea(23), Kc = ea(24), gb = ea(22), ac = ea(25), nd = Ca || Kc || gb || ac, Lc = Ca && rb(mc.userAgent.split("Edg/")[1]), od = rb(mc.appVersion.split("Trident/")[1]) + 4, Kb = Ia(37) || Ia(38) || Ia(39), pd = Ia(40) || Ia(41) || 
  Ia(42) || Ia(43), qd = 0 <= mc.userAgent.indexOf("Googlebot/"), ib = 0.9 > Y, rc = (Jb ? "ie5mac" : 5.5 > y ? "ie5win" : 6 > y ? "ie55" : 10 > y ? "ie" + (y | 0) : 7.2 > D ? "opr70" : 8 > D ? "opr72" : 9.5 > D ? "opr" + (D | 0) : Y && !Vb ? 1.4 <= Y ? "gck19" : 1.3 <= Y ? "gck13" : 1 <= Y ? "gck12" : ib ? 0.8 <= Y ? "gck08" : "gck07" : "gck09" : "modern") + ".css", bc = "", rd = Ia(1) || Ia(2) || Ia(3) || Ia(4) || Ia(8) || Ia(9), Mc, sb = 8 > y || 7.2 > D ? !1 : v, Nc = fb.transform !== v ? "transform" : 
  fb["-o-transform"] !== v ? "-o-transform" : fb["-ms-transform"] !== v ? "-ms-transform" : fb.MozTransform !== v ? "-moz-transform" : fb["-webkit-transform"] !== v ? "-webkit-transform" : "", Xa = [], Oc = [], jb = [], sc, Pc, Qc, Rc, cc, Sc, Tc, dc, ec, Uc = !1, tc = 525 > qa || 3.1 > Fa || 2.2 > gb || 10 > D || Y && !Vb || ea(26) || 10 > ea(3) || Ia(34) || Ia(32) || Ia(3), aa, Lb, fc, Vc, sd = !!ra.getBoundingClientRect, gc = [], hc = [], uc, Wc, vc, Xc, Ya = $b.now || function() {
    return +new $b();
  }, Cb, Mb, Yc, Db, Zc, Oa, lb, $c, wc, wa, Wb, ad, bd, xc, Ra, Eb, cd, dd, Za, Sa, tb, mb, ub, ed, ic, nb, Fb, fd, La, $a, gd, ob, ja, Pa, cb, Nb, yc, Qb, Ob, zc, Ac, jc, hd, id, jd, Rb, Ka, Bc, Ub, Zb, xb, Fc, Ea, ld, Gc;
  (function() {
    function N() {
      for (var T, ha = 0, U = Ya(); ha < L.length;) {
        U < L[0].t ? ++ha : (T = L.splice(ha, 1)[0], T.f(T.p));
      }
      ka = L.length ? oc(N, Da) : 0;
    }
    function H() {
      for (var T, ha = 0; ha < P.length; ++ha) {
        T = P[ha], T.f();
      }
    }
    function K() {
    ...
    Wc = K;
    var P = [], za = 500, Aa = 0, na, L, Da, Ga, ka;
    if (5 > y || Jb) {
      Z._wdb_onlooptimer = H, H = "_wdb_onlooptimer()";
    }
    aa = function(T, ha, U) {
      L.length || (ka = oc(N, Da));
      L.push({f:T, p:ha, u:++Ga, t:Ya() + (Da < U ? U : Da)});
      return Ga;
    };
    Lb = function(T) {
      for (var ha = L.length, U; U = L[--ha];) {
        if (U.u === T) {
          L.splice(ha, 1);
          break;
        }
    ...
    Xc = X;
    L = [];
    Da = Fa | 0 || 530 <= qa && 534 > qa ? 64 : 16;
    Ga = 0;
    E("[core] TIMER_INTERVAL:" + Da);
    if (5 > y || Jb) {
  ...
  (function() {
    ...
    function X(a, d) {
      ...
      for (var t = [], B = 0, J = n.length; B < J; ++B) {
        t[B] = n[B];
      }
      return t;
    }
    function P(a, d) {
      var n = [], t = 0, B, J = -1, V, R, ba;
    ...
    function Aa(a, d, n, t, B, J) {
      ...
      if (ma) {
        ...
        d = J ? M.createElementNS("http://www.w3.org/2000/svg", n) : M.createElement(n);
        if (t) {
          for (V in t) {
            if ((a = t[V]) || 0 === a) {
              switch(V) {
    ...
    function T(a, d, n, t) {
      if (!t && D) {
        if ("tabindex" === d) {
          ...
          "href" === d && ka(a, "tabindex", !0) !== ob && "A" === Ga(a) && T(a, "tabindex", ob, !0);
        }
      }
      if (8 > D || 5.5 > y) {
    ...
    Wb = function(a, d, n, t, B) {
      d = Aa(0, a, d, n, t, B);
      ma || (za(a).insertBefore(d, a), Ma && null != t && (9 > y ? na(d, t) : L(d, t)));
      return d;
    };
    ad = function(a, d, n, t, B) {
      d = Aa(1, a, d, n, t, B);
      var J;
      ma || ((J = a.nextSibling) ? Oa(J).insertBefore(d, J) : Oa(a).appendChild(d), Ma && null != t && (9 > y ? na(d, t) : L(d, t)));
      return d;
    };
    bd = na;
    xc = function(a, d) {
          ...
          case 1:
            if (!V) {
              ...
              if (la) {
                for (var e = 0; e < la; ++e) {
                  b = ba[e];
                  b.specified && (B[++J] = " " + b.name + '="' + H(b.value).replace('"', "&quot;") + '"');
                }
              }
              B[++J] = ">";
            }
            ...
            V || !t.firstChild && -1 !== "BR,HR,LINK,IMG,META".indexOf(R.toUpperCase()) || (B[++J] = "</" + R + ">");
            break;
          case 3:
          case 4:
            B[++J] = H(t.nodeValue);
    ...
    Xa.splice(0, 0, function() {
      ...
      Ab = Cb("jsMain");
      var d = !(8 > D || 5 > y || Jb || ib), n = Rc, t = 7 > y, B = ["og:", "twitter:", "fb:"], J = [], V = [], R = {};
      a(Ib);
    });
  })();
  (function() {
    ...
    function Aa(g, k, w, q) {
      var F, ia, pa, db;
      if (ma) {
        g.removeEventListener(k, w, q ? Ba ? q : q.capture || !0 === q : !1);
      } else {
        F = sa[k];
        ...
        if (F) {
          if (Na) {
            ...
            for (q = F.length; k < q; k += 3) {
              F[k] === g && (F[k + 1] === w && F[k + 2] === ia ? F.splice(k, 3) : db = !0);
            }
            db || (ca ? g.detachEvent(pa, na) : y ? (g[pa] = eb, g[pa] = null) : delete g[pa]);
          }
        }
      }
    }
    function na(g) {
      var k = g || event, w = k.type, q, F, ia, pa, db;
      g = sa[w];
      w = "on" + w;
      q = 0;
      F = g.length;
      ...
      for (; q < F; q += 2) {
        ...
        if (pa === this) {
          db = g[q + 1];
          5.5 > y ? (pa[w] = db, pa[w](k), pa[w] = na) : db.call(pa, k);
        } else {
          7.2 > D && this === M && pa === Z && g[q + 1].call(pa, k);
        }
      }
      if (y) {
        return k.preventDefault = k.stopPropagation = eb, k.preventDefault = k.stopPropagation = v, k.returnValue;
      }
      xa && (k.defaultPrevented && "click" === k.type && "A" === k.target.tagName && k.target.getAttribute("href") && (Ja = !0), ia && !Ja && k.I(), k.I = k.stopPropagation = v);
      --Na;
      if (0 === Na) {
        for (g = Ma; g.length;) {
          Aa(g.shift(), g.shift(), g.shift(), g.shift());
        }
      }
      function bz() {
        event.returnValue = !1;
    ...
    function L() {
      ...
      Rb !== g && (P(Oc, Rb = g), E("p_cssAvailability:" + Rb));
    }
    function Da() {
      !Xa && Q && (Lb(Q), Q = aa(Ga));
    }
    ...
    var T = Z.matchMedia, ha, U = [], Ba, sa, ca, xa, ma, Na, Ma, Ja, a, d, n, t, B, J, V, R, ba, la, e, b, c, m, l, u, h, C, r, O, x, A, Q, oa, ta, Ha, Ta, hb, Ua, Pb, vb, wb;
    Xa.push(function() {
      K = v;
    ...
    ja = function(g, k, w, q) {
      var F, ia, pa;
      if (ma) {
        g.addEventListener(k, w, q ? Ba ? q : q.capture || !0 === q : !1);
      } else {
        F = sa[k];
        ia = !!q === q ? q : q ? !!q.capture : !1;
        q = "on" + k;
    ...
    Pa = Aa;
    Ba = !y && !Jb && (new md('try{var r,o=Object.defineProperty({},"passive",{get:function(){r=!0}});addEventListener("t",o,o);removeEventListener("t",o,o);return r}catch(e){}'))();
    sa = {};
    ca = !1;
    xa = 525.13 > qa;
    ...
    Na = 0;
    Ma = [];
    xa && Ib.addEventListener("click", function(g) {
      if (Ja) {
    ...
    hd = function(g, k) {
      if (n) {
        ...
        for (var w = R, q = 0, F = w.length; q < F; q += 2) {
          if (w[q] === g && w[q + 1] === k) {
            w.splice(q, 2);
            w.length || (J ? la = Vc(la) : (B || V) && Pa(M, "focus", ba, !0));
            break;
          }
        }
      }
    };
    n = 6 <= y || kb || 52 <= Y || 15 <= Ca || 534 <= qa || 5 <= Fa || Kc || 4 <= gb || 4 <= ac || 11.6 <= ea(8) || 12 <= ea(9);
    t = 8 <= D || Ca || gb || ac || qa || Fa;
    B = 8 > D;
    J = 6 > y;
    V = 52 > Y || Bb;
    if (V || B) {
      ...
      c = function() {
        ...
        if (e !== g) {
          ...
          for (var k = R, w = 0, q = k.length, F, ia; w < q; w += 2) {
            if (F = k[w], F === g || Eb(F, g)) {
              ia = F.onmousemove, F.onmousemove = k[w + 1], F.onmousemove({type:"focusin", target:g, preventDefault:eb, stopPropagation:eb}), ia ? F.onmousemove = ia : (F.onmousemove = eb, F.onmousemove = null);
            }
          }
        }
        Z.onerror = b;
    ...
    l = 60 > Y || Bb;
    if (89 <= Y || 89 <= Ca || Kb && 79 <= Lc || T && (T("(forced-colors:none)").matches || T("(forced-colors:active)").matches)) {
      Bc = !0, K("(forced-colors:active)", function(g) {
        u = g.matches;
        Ka = N();
        P(jb, Ka);
        E("(forced-colors:active):" + Ka);
      });
    } else if (10 <= y || kb || Kb && Lc) {
      Bc = !0, K("(-ms-high-contrast:black-on-white)", function(g) {
        u = h = g.matches;
    ...
    } else if (Kb && (y || Y && 0 <= Wa.conpare(bb, "1.8.1") || Bb)) {
      r = function() {
        function g(q, F) {
          var ia;
          if (F && "transparent" === q) {
    ...
    cb(function() {
      function g() {
        q ? (F = w[--q], x && tb(F, "src", F.G), Pc(k, x ? F.G : F.src)) : O = v;
      }
      function k(pa) {
        X(O, {C:F, D:pa}, !q);
        g();
    ...
    ta ? fc(function() {
      var g = Z.pageYOffset;
      Ha !== g && (Ha = g, ka({type:"scroll", cancelable:!1, stopPropagation:eb, preventDefault:eb}));
    ...
    Ta = 9 <= y || kb || 17 <= Y || Bb || 31 <= Ca || 537.7 <= qa || 7 <= Fa;
    hb = 6 <= y || kb || 9 <= D || Ca || 522 <= qa || Fa;
    Ua = Vb;
    ...
    if (Pb) {
      ...
      wb = function(g) {
        for (var k = vb, w = g.target, q = 0, F = k.length, ia; q < F; q += 2) {
          ia = k[q], (ia === w || Eb(ia, w)) && k[q + 1].call(ia, g);
        }
      };
    }
  })();
  (function() {
    ...
    function K(l) {
      ...
      M.fonts.load(u).then(function(h) {
        ...
        (h = Aa(n)) ? aa(H, h) : (E("[webFontTest] mesureWebFont() : false"), P(!0));
      }, function(h) {
    ...
    function P(l) {
      ...
      (l = Aa(n, R)) ? (E("[webFontTest] testWebFont mesurement success : " + l), H(l)) : X(R) ? (E("[webFontTest] testWebFont timeout!"), e ? L() : Ga ? H(0) : sb !== v ? na(sb) : sc(na)) : aa(P);
    }
    function za() {
      return wa(ra, 5 > y ? "div" : "span", {"aria-hidden":"true", style:{position:"absolute", top:0, left:0, visibility:"hidden", fontSize:"72px", "-webkit-font-feature-settings":'"liga"', "-moz-font-feature-settings":15 > Y ? '"liga=1"' : '"liga"', "-ms-font-feature-settings":'"liga" 1', "-o-font-feature-settings":'"liga"', "font-feature-settings":'"liga"'}}, Ba);
    }
    function Aa(l, u) {
      var h = 0, C = -1, r = [], O, x, A;
      if (!m) {
      ...
      for (5 > y ? b || (b = za()) : Oa(b) || ra.appendChild(b); O = ca[++C];) {
        La(b, "fontFamily", '"' + l + '",' + O);
        A = b.offsetWidth;
      ...
      !y && h && J && (b.textContent = J, A = b.offsetWidth, b.textContent = V, h = A === b.offsetWidth ? 2 : 1, b.textContent = Ba);
      b = Ra(b);
    ...
    function na(l) {
      ...
      l ? (e = !0, R = U, E("[webFontTest] webFontTest_repeatToTestDataURIedCSSWebFont start!"), n = n.replace(T, ""), L()) : H(0);
    }
    function L() {
      var l, u;
      if (t) {
    ...
    sc = !1 === sb ? function(l) {
      ...
      var h, C;
      function u(r) {
        C && (C = Lb(C), sb = r, h.onload = h.onerror = eb, aa(l, r));
      }
      if (sb !== v) {
    ...
    Pc = function(l, u) {
      function h() {
        r || !O || C.complete ? (E("[imageTest] timer -> img.complete. img.width=" + C.width), aa(l, !!C.width), C.onerror = C.onload = eb, C = l = v) : (--O, aa(h));
      }
    ...
    Qc = function(l, u, h, C, r, O, x) {
      ...
      R = ba = x || ha;
      n = T + n;
      E("[webFontTest] WEBFONT_DEBUG_MODE : 1");
      E("[webFontTest] UNAVAILABLE_DUE_TO_BLOCKLIST : " + !!tc);
      ea(10) ? aa(H, 1) : tc ? aa(H, 0) : !M.fonts || 603 > qa || 11 > Fa ? (E("[webFontTest] No native font loader."), P(!0)) : (E("[webFontTest] Use Native font loader."), K(n));
    };
    var Ga = 9 > y, ka = 6 > Ca || D || 530 > qa || 5 > Fa || Ia(10), T = "bad_" + Ya() + "_", ha = 5E3, U = 500, Ba = "mmmmmmmmmmlliiiiiiiii", sa = 9 <= Ca && 18 > Ca || 3 > gb || 7 > Fa || qa && 0 >= Wa.conpare(bb, "536.11"), ca = ["monospace", "sans-serif", "serif"], xa, ma, Na, Ma, Ja, a, d, n, t, B, J, V, R, ba, la, e, b, c, m;
    tc || (sa && Ca && E("[webFontTest] hasWebKitFallbackBug : p_Chromium=" + Ca), sa && Fa && E("[webFontTest] hasWebKitFallbackBug : p_SafariMobile=" + Fa), sa && qa && E("[webFontTest] hasWebKitFallbackBug : p_WebKit=" + qa), sa && gb && E("[webFontTest] hasWebKitFallbackBug : p_AOSP=" + gb));
    xa = 14 <= kb || 36 <= Ca || 39 <= Y || 3 <= Bb || 602 <= qa && 0 <= Wa.conpare("10.12", pd) || 10 <= Fa;
    ma = 6 <= Ca || Y && 0 <= Wa.conpare(bb, "1.9.2") || Bb || 533 <= qa || 5 <= Fa || 4.4 <= gb || 11.5 <= D || kb || 9 <= ea(2) || 10 <= ea(3);
    Na = 2 <= Ca || Vb || Bb || 525 <= qa || 4 <= Fa || 2.2 <= gb || 10.1 <= D || kb || 9 <= ea(2) || 10 <= ea(3);
    Ma = Na;
    Ja = 5.1 <= Kb && 5.2 >= Kb && 40 > Ca || 6 <= Kb && 6.1 > Kb && 51 > Ca || 37 > Ca || 525 <= qa || 3.1 <= Fa || 3 <= gb || 11.5 <= D;
    a = 4 <= ea(2) || 10 <= ea(3);
  })();
  (function() {
    var H, K, X, P, za, Aa, na, L, Da, Ga, ka, T, ha, U, Ba, sa, ca, xa, ma, Na, Ma, Ja, a, d, n, t, B, J, V, R, ba, la;
    function N(e) {
      var b, c, m, l;
      if (2 !== e) {
        E("[VectorIcon] " + e);
        ...
        if (m) {
          if (1 === e) {
            ...
            if (V) {
              Z.VectorIconFallback = bz, dc(Ea + "js/vector-icon-svg-fallback.js");
            } else {
              for (; c < m; ++c) {
                Ra(b[c]);
              }
      ...
      function bz() {
        ec(Ea + "js/vector-icon-svg-fallback.js");
        return [la, b, wa, dd, J];
      }
      bz = !1;
    }
    zc(function(e) {
      ...
      e = e.D;
      c = Oa(b);
      !nb(c, "aBodyRoot") && e ? Fb(c, "js-image-has-been-loaded") : e || Sa(b, "alt") || "lazy" === Sa(b, "loading") || La(b, "display", "none");
    });
    ib && (Xa.splice(1, 0, function() {
      for (var e = Zc(Ab, "RichLink-sep"), b, c, m, l, u, h; b = e.shift();) {
    ...
    if (Y && 0 > Wa.conpare(bb, "0.9.5")) {
      ...
      cb(function() {
        ...
        ja(M, "keyup", na);
        jc(ra, L);
        ib || (ja(Z, "blur", ha), ja(ra, "click", T));
      });
      Aa = ib ? function(e) {
        16 === e.keyCode ? H = !0 : 9 === e.keyCode && P && Da(P, !0) && (P.blur && P.blur(), e.stopPropagation(), e.preventDefault(), aa(ka));
      } : function(e) {
      ...
      L = ib ? function(e) {
        ...
        if (P === b) {
          ...
          b === X ? (e.stopPropagation(), ka(!0)) : (b.blur && Ba(b), e.preventDefault(), ka());
        } else {
          if (e = P) {
            P = v, Ba(e);
          }
      ...
      ka = function(e) {
        za = 0;
        X && (ib || ja(X, "blur", U), P = X, X = v, e || P.focus());
      };
      if (!ib) {
        T = function(e) {
          var b = e.target, c;
    ...
    D && cb(function() {
      for (var e = Db(ra, "a"), b = e.length, c = 0, m; c < b; ++c) {
    ...
    5.5 <= y && 8 > y && jb && Ac(function(e) {
      for (var b = Db(ra, "a"), c = b.length, m = 0; m < c; ++m) {
        b[m].hideFocus = !e;
      }
    });
    if (!Bc && jb) {
      B = function() {
        t = wa(zb, "link", {type:"text/css", rel:"stylesheet", media:"screen", href:Ea + "css/" + bc + "hc/" + rc});
        if (Nc || 5.5 <= y && 9 > y && Mc) {
          Fb(ra, "js-canuse-css-rotate-when-forced-colors-mode"), E("js-canuse-css-rotate-when-forced-colors-mode!");
        }
        B = v;
      };
      Ac(function(e) {
        e && !t ? B() : t && (e ? zb.appendChild(t) : Ra(t));
      });
    }
    Ob(function(e) {
      if (e) {
        return Qc(N, "web-doc-base", [1, Ea + "iconfont/woff2.css", 2, Ea + "iconfont/woff.css", 3, Ea + "iconfont/ttf.css", 5, Ea + "iconfont/eot.css", 6, Ea + "iconfont/svg.css"], "js-myIconFont-testCssReady", R, ba), N = v, !0;
      }
    });
    J = 8 <= ea(8) && 9 > D;
    V = 9 <= y || kb || 1.8 <= Y || Bb || 8 <= ea(8) || 9 <= ea(9) || 3 <= ea(22) || nd || 312.6 <= qa && 312.7 >= qa || 419.3 <= qa || Fa;
    R = "IE";
    ba = "\ueadb";
  ...
  (function() {
    function N(f) {
      var p = ba.length, G, I, da, z, S, W, fa;
          ...
          if (S.B === this || S.m === this) {
            ...
            if (S.M) {
              if (La(p, "width", S.X), p.src = S.W, ic(W, S.R), p = S.H) {
                $a(p, S.P), fd(p, "js-captioned-thumbnail__large");
              }
            } else {
              if (I = S.K) {
                delete S.K;
                if (S.J) {
                  ...
                  if (2 === S.J) {
                    ...
                    fa = I.length;
                    if (da = I[fa - 1]) {
                      (z = rb(da.substr(1))) && da === "s" + z ? I[fa - 1] = "w" + G : I[fa] = "w" + G;
                    }
                    I = I.join("=");
                  } else {
                    I = I.split("/");
                    fa = I.length;
                    if (da = I[fa - 2]) {
                      (z = rb(da.substr(1))) && da === "s" + z ? I[fa - 2] = "w" + G : I.splice(fa - 1, 0, "w" + G);
                    }
                    I = I.join("/");
                  }
                }
              ...
              S.R = ed(W);
              Fb(W, "js-pica-thumbnail__large");
              La(p, "width", "");
              p.src = S.U;
              if (p = S.H) {
                $a(p, ""), Fb(p, "js-captioned-thumbnail__large");
              }
            }
            S.M = !S.M;
            break;
    ...
    function P(f, p, G) {
      function I(pb) {
        ...
        if (O) {
          ...
          fa = m ? "position:fixed;width:" + Cc + "px;top:" + (pb - da + ya) + "px" : u ? "top:" + pb + "px" : "position:absolute;top:" + pb + "px;left:0";
          if (l && fa) {
            Xb = 8 > y ? " " : ",";
            fa += ";clip:rect(" + (0 > pb ? -pb + "px" + Xb + Cc + "px" + Xb + Qa : "0" + Xb + Cc + "px" + Xb + (pb + Qa < Yb ? Qa : Yb - pb)) + "px" + Xb + "0)";
          }
        }
      }
      var da = A, z = C, S = h.offsetTop === z.offsetTop, W = 0, fa = "", ab = !0, Dc, Qa, Yb, Gb, Sb, kc, lc, kd, td, Hb, Tb;
      if (S) {
        for (var va = 0, ya = 0, Va = z; Va && Va !== ra;) {
          ya += Va.offsetTop, Va = Va.offsetParent;
        }
        W = x;
        Va = 11 > y ? Ib.offsetHeight : Z.innerHeight;
        Dc = z.offsetHeight;
        Qa = r.offsetHeight;
        Yb = Qa < Dc ? Dc : Qa;
        Gb = da;
        ...
        if (p !== v) {
          ...
          f = ab + G;
          if (Gb || Sb) {
            return Va <= G ? (p = ya, L("4.1.1")) : Gb ? (p = lc - G, L("4.1.2")) : (p = ya + G - Va, L("4.1.3")), ta = v, Z.scroll(0, p), L("4.1.*"), oa;
          }
          Qa <= Tb ? (va = 3, L("4.2")) : G <= Tb ? Qa - p <= Tb ? (va = 2, L("4.3.1")) : z <= ab && f <= Hb ? z < ya + W && (va = 4, L("4.3.2")) : z <= ab && ab <= Hb ? (va = 5, L("4.3.3")) : z <= f && f <= Hb ? (va = 4, L("4.3.4")) : f < z ? (va = 4, L("4.3.5")) : (va = 5, L("4.3.6")) : (va = 4, L("4.4"));
          ab = !1;
        } else {
          f !== v ? Qa <= Tb ? (va = 7, ab = !1, L("3.1")) : (W -= 60 * f, va = Hb - ya - Qa, f = z - ya, W < va ? (W = va, L("3.2.1")) : f < W ? (W = f, L("3.2.2")) : L("3.2.3"), va = 6) : Dc <= Qa || (Gb ? (va = 1, L("2.2.1")) : Sb ? L("2.2.2") : Qa <= Tb ? (va = 3, L("2.3")) : z < kd ? (va = 3, L("2.4.1")) : td < Hb ? (va = 2, L("2.4.2")) : da < ya + Qa - Tb ? L("2.4.3") : (va = 2, L("2.4.4")));
        }
        switch(va) {
          case 0:
            I(0);
    ...
    function Aa(f) {
      ...
      if (Rb) {
        ...
        if (Eb(I, G)) {
          ...
          ja(G, "blur", na);
          if (O) {
            p = G.getBoundingClientRect(), f = p.bottom - p.top, da = p.top - I.getBoundingClientRect().top | 0;
          } else {
            f = G.offsetHeight;
            z = G;
            if (p) {
              for (var S = []; z && (Y ? Eb(I, z) : I !== z);) {
          ...
          c ? (oa = [da, f], Ha && Lb(Ha), Ha = aa(K, 7, 1 > Y || 536 > qa || 14 > Ca ? 500 : 0)) : (A = qc(), P(v, da, f));
          T(da, f);
        }
      }
    }
    ...
    function L(f) {
      Ua && (k && (k = Lb(k)), k = aa(Da, 0, 1400), Ua.innerHTML += " " + f);
    }
    function Da() {
      Ua.innerHTML = "";
    }
    ...
    function ka(f, p, G, I, da, z, S) {
      wb && (La(wb, "top", ((f + G) / 10 | 0) + "px"), La(wb, "height", (p / 10 | 0) + "px"), La(vb, "height", (da / 10 | 0) + "px"), La(Pb, "height", (ra.scrollHeight / 10 | 0) + "px"), Ta.innerHTML = "conY:" + G + "/sidY" + f + ", conH:" + I + "/sidH" + p + ", focY:" + z + " focH:" + S);
    }
    function T(f, p) {
    ...
    function U() {
      M.fullscreenElement || M.fullscreen || M.webkitIsFullscreen || M.msFullscreenElement || Z.fullScreen ? (tb(q, "id", "blog2slide-root"), pa[1].parentNode.insertBefore(F, pa[1]), Ba(), M.onkeydown = sa) : ia && (Ra(F), mb(q, "id"), mb(ia, "id"), ia = M.onkeydown = v);
    }
    function Ba() {
      ia && mb(ia, "id");
      db = 0 < db ? Ec < db ? Ec : db : 0;
      ia = pa[db];
    ...
    Tc = function(f, p, G, I, da) {
      ...
      if (xa) {
        ...
        if (I) {
          ...
          S = wa(zb, "link", {type:"text/css", rel:"stylesheet"});
        }
        if (!a) {
          (z = Cb(G)) ? mb(z, "id") : z = wa(ra, "div", {"aria-hidden":"true", className:G});
          W = z.offsetWidth;
    ...
    var ca = 5E3, xa = Y && 0 > Wa.conpare(bb, "0.9.1"), ma = 11 <= y || kb || 9 <= D && 9.5 > D, Na = 11 > y, Ma = 7.2 <= D && 7.5 > D, Ja = 9 > Y && !xa || 19 > Ca || 4.3 > gb || 2 > ac || 536 > qa || 6 > Fa || 7 <= D && 9 > D && !Ma, a = !xa && !ma && !Na && !Ma && !Ja, d = a ? function(f, p, G) {
    ...
    }, t, B, J, V, R, ba, la, e, b, c, m, l, u, h, C, r, O, x, A, Q, oa, ta, Ha, Ta, hb, Ua, Pb, vb, wb, g, k, w, q, F, ia, pa, db, Ec;
    Sc = Y && 0 >= Wa.conpare(bb, "0.9");
    cc = !(7.2 > D || Sc);
    dc = function(f) {
      t ? Xa ? M.write('<script src="' + f + '">\x3c/script>') : qb("[DynamicScvriptLoader] Document already loaded! " + f) : Xa || V.length ? V.push(f) : R(f);
    };
    ec = function(f) {
      t ? E("[DynamicScvriptLoader] " + f + " loaded.") : f === J ? R(V.shift()) : qb(f + " <> " + J);
    };
    t = !cc;
    B = cc && 7.5 > D;
    if (!t) {
      ...
      R = function(f) {
        if (J = f) {
          B ? Fc[0].src = f : wa(zb, "script", {src:f});
        }
      };
    }
    ba = [];
    ...
    if (!Jc) {
      e = fb.transition !== v || fb["-o-transition"] !== v || fb["-moz-transition"] !== v || fb["-webkit-transition"] !== v;
      zc(function(f) {
        var p, G, I, da, z, S, W;
        if (f.D && Ab) {
          f = f.C;
          p = Oa(f);
          G = "";
          if ("A" === Za(p) && 1 === $c(p).length) {
            da = Sa(p, "href");
            z = da.split("?")[0].split("#")[0].split(".");
            z = (z[z.length - 1] || "").toLowerCase();
            if ((I = 0 < da.indexOf("blogger.googleusercontent.com/img/")) || 0 <= ".jpg.png.gif.bmp.jpeg.webp.".indexOf("." + z + ".")) {
              ja(p, la, N);
              ja(f, "click", N);
              ja(p, "click", H);
              e && (G = f.naturalWidth + "px", La(f, "width", G));
              Fb(p, "js-pica-thumbnail");
              for (z = p; z = Oa(z);) {
                if (nb(z, "caption")) {
                  Fb(z, "js-captioned-thumbnail");
                  S = z;
                  W = gd(S);
                  break;
                }
              }
              ba.push({m:p, H:S, P:W, W:f.src, X:G, K:da, B:f, J:I ? 0 < da.indexOf("/img/a/") ? 2 : 3 : 0 < da.indexOf(".bp.blogspot.com/") ? 1 : 0});
            }
          }
        }
      });
    ...
    c = !(9 > y || D || 1 <= Y && 1.3 > Y || Uc);
    m = !(5 > Fa || 2.2 > gb || 6 > ea(12) || Ia(32) && 534 > qa || Ia(34) || 7 > y || 9 > D || 1 > Y);
    l = m || 6 === y || 1 > Y;
    u = 7.5 > D;
    O = sd && Nc;
    x = 0;
    ...
    ld || Jc || (Ob(function(f) {
      ...
      if (f) {
        ...
        ja(Z, "blur", X);
        for (jc(r, Aa); 1 < lb(h).length;) {
          r.appendChild(lb(h)[1]);
        }
        for (; p = b[++f];) {
          id(Cb(p), za);
        }
        y || kb || 2 > Ca || (Q = fb.perspective !== v || fb.MozPerspective !== v || fb["-webkit-perspective"] !== v);
        K();
        return !0;
      }
    }), Nb(function() {
      ...
      Ob(function(f) {
        ...
        if (f) {
          ...
          if (m) {
            ...
            ib || ($a(f, "width:100%;height:100%;overflow:auto;position:relative"), $a(Ib, "overflow:hidden"), $a(ra, "overflow:hidden"));
            f = ad(f, "div");
    ...
    cb(function() {
      ...
      if (Ab) {
        for (var p = Db(Ab, "blockquote"), G, I = -1, da, z; G = p[++I];) {
    ...
    cb(function() {
      ...
      if (f) {
        ...
        0 !== p || w ? (f.innerHTML = '<button class="btn">\u30b9\u30e9\u30a4\u30c9\u3092\u958b\u59cb\u3059\u308b</button>', ja(f.firstChild, "click", ha), f = Oa(f), q = Oa(f), pa = Db(f, "section"), F = M.createElement("h1"), F.innerHTML = Db(ra, "h1")[0].innerHTML, Ec = pa.length, pa.splice(0, 0, F), 0 !== p ? ja(M, p + "ullscreenchange", U) : y ? ja(M, "MSFullscreenChange", U, !1) : yc(U)) : Ra(f);
      }
    });
  })();
  Zb = !Hc || .9 > Y || 8 > D || 5.5 > y;
  (function() {
    ...
    function H(b, c) {
      return Zb ? new ha(b, c) : new Hc(b, c);
    }
    function K(b, c, m, l, u) {
      var h = U.codeBlocks[U.codeBlocks.length - 1], C = T(), r = C - sa;
      switch(m || 0) {
        case 1:
          U.initRegExpCount++;
          U.initRegExpTotal += r;
          U.initRegExpMax < r && (U.initRegExpMax = r, U.initRegExpSource = u.toString(), U.initRegExpInstance = u);
          break;
        case 2:
          h.decorateCount++;
          h.decorateTime += r;
    ...
    function za() {
      ...
      if (r) {
        ...
        if (A) {
          ...
          Ha || (ca !== c ? K(d, v, 2) : K(za, v, 2));
        } else {
          C.push(h + u, x), K(za, v, 2);
        }
      } else {
        c.h ? (ca = c.h.g.shift()) ? K(d, v, 2) : (ca = c.h, K(za, v, 2)) : K(V, v, 2);
      }
    }
    function Aa(b) {
      var c, m;
    ...
    ka = "pln str com pun lit kwd atv typ dec tag atn src".split(" "), T = $b.now || function() {
      return +new $b();
    }, ha, U = {useRegExpCompat:Zb, initRegExpTotal:0, initRegExpMax:0, initRegExpSource:"", initRegExpCount:0, codeBlocks:[]}, Ba, sa, ca, xa, ma, Na, Ma, Ja, a, d, n, t, B, J, V, R, ba, la, e;
    Ba = T();
    ...
    t = function(b) {
      ...
      n.length ? K(Aa, b, 2) : (l.i ? l.h && (l.h.g[0].i = u) : l.i = u, K(d, v, 1));
    };
    B = function(b, c) {
      function m(O) {
        var x = O.nodeType;
    ...
    J = function(b, c, m) {
      ...
      for (c = C.length; r < c; ++r) {
        h = C[r], ic(h, "L" + (r + b) % 10), h.firstChild || bd(h, "\u00a0"), O.appendChild(h);
      }
    };
    V = function() {
    ...
    la = function(b) {
      R.push(b);
      ba = R.length;
      1 === ba && (Gc ? aa(Gc, e) : xb ? xb.push(function() {
        aa(e);
      }) : aa(e));
    };
    e = function() {
        ...
        if (c) {
          ...
          if (nb(c, "prettyprint") && !nb(c, "prettyprinted")) {
            ...
            if (!m) {
              ...
              U.codeBlocks.push({elm:c, lang:l, readyTime:T() - Ba, decorateTime:0, decorateCount:0, updateDOMTime:0});
              K(a);
              return;
            }
          }
  ...
  Fc = M.scripts || Mb("script");
  Ea = Fc[Fc.length - 1].src.split("/");
  --Ea.length;
  ...
  cb(function() {
    var N;
    (N = Cb("logger")) || alert("#logger not found!");
    N ? (E = bz, qb = function(H) {
      wa(N, "DIV", {style:{color:"red"}}, H);
    }, Z.onerror = function(H, K, X) {
      qb(H + ", " + K + ", " + X);
      return !0;
    }) : Z.console ? (E = console.log, qb = console.error) : D ? (E = eb, qb = opera.postError) : E = qb = eb;
    for (; gc.length;) {
      E(gc.shift());
    }
    for (; hc.length;) {
  ...
  6.1 > Fa && (Qb ? Qb(uc) : ja(Z, "scroll", uc));
  Nb(Wc);
  6.1 > Fa && (Qb ? Qb(vc) : ja(Z, "scroll", vc));
  Nb(Xc);
  10 > y && (11 !== od || 5 !== y) || (9 > D || 1 > Y || !Jb && !Z.addEventListener ? M.write('<link href="' + Ea + "css/" + bc + rc + '" rel="stylesheet"' + (8 > D ? "" : ' media="screen,handheld,projection,print"') + ">") : 419.13 > qa && cb(function() {
    wa(zb, "link", {href:Ea + "css/" + bc + rc, rel:"stylesheet", media:"screen,handheld,projection,tv,print"});
  }));
  if (Zb) {
    if (cc) {
      Gc = function(N) {
