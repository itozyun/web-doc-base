...
(function(Ya, Y, ib, Fc, N, hc, id, Vb, qb, ic, jc, Gc, kc, v) {
  ...
  (function() {
        ...
        for (n in b) {
          ...
          if (null != D && "" !== D) {
            if ("style" === n) {
              A[++c] = ' style="';
              for (u in D) {
                for (var Q = ++c, U, X = [], ia = u.split(""), Ba = ia.length; Ba;) {
    ...
    ra = function(a, b, m, A, c) {
      b = na(2, a, b, m, A, c);
      L || (a.appendChild(b), pa && null != A && K(b, A));
      return b;
    };
    Rb = function(a, b, m, A, c) {
      b = na(0, a, b, m, A, c);
      L || (ca(a).insertBefore(b, a), pa && null != A && K(b, A));
      return b;
    };
    Zc = function(a, b, m, A, c) {
      b = na(1, a, b, m, A, c);
      var n;
      L || ((n = a.nextSibling) ? Qa(n).insertBefore(b, n) : Qa(a).appendChild(b), pa && null != A && K(b, A));
      return b;
    };
    $c = K;
    tc = function(a, b) {
    ...
    Va.splice(0, 0, function() {
      function a(Q) {
        Q = lb(Q);
        for (var U = Q.length, X, ia, Ba; U;) {
          if (X = Q[--U], ia = X.nodeType, 8 === ia) {
            b && u.push(X);
          } else if (1 === ia) {
  ...
  (function() {
    ...
    function ca(f) {
      ...
      b && (g.defaultPrevented && "click" === g.type && "A" === g.target.tagName && (A = !0), R && !A && g.K(), g.K = g.stopPropagation = v);
      function bz() {
        event.returnValue = !1;
      }
      bz = !1;
    ...
    la = function(f, g, y, p) {
      if (m) {
        ...
        if (p) {
          ...
          pa[g] = p = [R], a || (g = f[za], "function" === typeof g && g !== ca && p.unshift({j:f, i:g}));
        }
    ...
    La = function(f, g, y, p) {
      if (m) {
        ...
        var R, za, Ja;
        if (p) {
          for (R = p.length; za = p[--R];) {
            za.j === f && (za.i === y ? p.splice(R, 1) : Ja = !0);
          }
    ...
    yc = function(f, g) {
      if (u) {
        ...
        for (var y = ia, p = 0, R = y.length; p < R; ++p) {
          if (y[p] === f && y[p + 1] === g) {
            return;
          }
        }
    ...
    dd = function(f, g) {
      if (u) {
        ...
        for (var y = ia, p = 0, R = y.length; p < R; ++p) {
          if (y[p] === f && y[p + 1] === g) {
            y.splice(p, 2);
            y.length || (U ? Sa = Tc(Sa) : (Q || X) && La(N, "focus", Ba, !0));
            break;
          }
        }
      }
    };
    var u = 6 <= B || jb || 52 <= Z || 15 <= Da || 534 <= sa || 5 <= Ca || Ic || 4 <= kb || 4 <= Xb || 11.6 <= da(8) || 12 <= da(9), D = 8 <= I || Da || kb || Xb || sa || Ca, Q = 8 > I, U = 6 > B, X = 52 > Z || Wb;
    if (X || Q) {
      var ia = [];
      var Ba = function(f) {
        var g = ia, y = Q ? N.activeElement : f.target;
        if (Q) {
          var p = f;
        ...
        for (var R = 0, za = g.length; R < za; ++R) {
          var Ja = g[R];
      ...
      var Sa, Ia, Ga, xa = function() {
        ...
        if (Ia !== f) {
          Ia = f;
          for (var g = ia, y, p = 0, R = g.length; p < R; ++p) {
    ...
    eb(function() {
      function f() {
        p ? (R = y[--p], J && sb(R, "src", R.J), Nc(g, J ? R.J : R.src)) : l = v;
      }
      function g(Ja) {
        oa(l, {G:R, H:Ja}, !p);
        f();
      ...
      if (12 > I || 532 > sa) {
        ...
        for (; p;) {
          var R = y[--p];
          var za = 9 > B ? R.complete : 0 <= R.naturalWidth ? R.naturalWidth : R.width;
          ea(l, {G:R, H:za}, !p);
        }
        l = v;
      }
    ...
    var t = [], F = 1 > Z || 1.2 <= Z && 1.8 > Z || 7.2 >= I, S;
    F ? bc(function() {
      var f = Y.pageYOffset;
    ...
    ed = function(f, g) {
      if (ka) {
        ...
        for (var y = Na, p = 0, R = y.length; p < R; ++p) {
          if (y[p] === f && y[p + 1] === g) {
            return;
          }
        }
    ...
    if (Ma) {
      var Na = [], bb = function(f) {
        for (var g = Na, y = f.target, p, R = 0, za = g.length; R < za; ++R) {
          p = g[R], zb(p, y) && g[R + 1].call(p, f);
        }
      };
    }
  })();
  (function() {
    ...
    function P(e) {
      ...
      N.fonts.load(w).then(function(r) {
        ...
        (r = ha(Q)) ? ba(H, r) : (C("[webFontTest] mesureWebFont() : false"), ea(!0));
      }, function(r) {
    ...
    function ea(e) {
      ...
      (e = ha(Q, Sa)) ? (C("[webFontTest] testWebFont mesurement success : " + e), H(e)) : oa(Sa) ? (C("[webFontTest] testWebFont timeout!"), Ga ? na() : Ea ? H(0) : rb !== v ? ca(rb) : oc(ca)) : ba(ea);
    }
    function ha(e, w) {
      var r = 0, q = -1, l = [];
      if (!h) {
      ...
      $a(xa);
      5 > B && (xa = v);
      w && (r || oa(w)) && C("[webFontTest] " + e + " " + l.join(", "));
      return r;
    }
    function ca(e) {
      C("[webFontTest] onTestDataURIComplete : " + e);
      e ? (Ga = !0, Sa = L, C("[webFontTest] webFontTest_repeatToTestDataURIedCSSWebFont start!"), Q = Q.replace(ma, ""), na()) : H(0);
    }
    function na() {
      if (U) {
        for (; U.length;) {
    ...
    Oc = function(e, w, r, q, l, J, z) {
      ...
      da(10) ? ba(H, 1) : pc ? ba(H, 0) : !N.fonts || 603 > sa || 11 > Ca ? (C("[webFontTest] No native font loader."), ea(!0)) : (C("[webFontTest] Use Native font loader."), P(Q));
    };
    var Ea = 9 > B, wa = 6 > Da || I || 530 > sa || 4 > Ca, ma = "bad_" + db() + "_", T = 5E3, L = 500, aa = "mmmmmmmmmmlliiiiiiiii", pa = 21 > Da || 7 > Ca || sa && 0 >= Ya.conpare(Za, "536.11"), a = ["monospace", "sans-serif", "serif"];
    pc || (pa && Da && C("[webFontTest] hasWebKitFallbackBug : p_Chromium=" + Da), pa && Ca && C("[webFontTest] hasWebKitFallbackBug : p_SafariMobile=" + Ca), pa && sa && C("[webFontTest] hasWebKitFallbackBug : p_WebKit=" + sa));
    var b = 14 <= jb || 36 <= Da || 39 <= Z || 602 <= sa || 10 <= Ca, m = 6 <= Da || Z && 0 <= Ya.conpare(Za, "1.9.2") || 525 <= sa || 3.2 <= Ca || 4.4 <= kb || 11.1 <= I || jb || 9 <= da(2) || 10 <= da(3), A = 2 <= Da || Qb || 525 <= sa || 3.2 <= Ca || 2.2 <= kb || 10 <= I || jb || 9 <= da(2) || 10 <= da(3), c = A, n = 525 <= sa || 3.2 <= Ca || 38 > Da || 3 <= kb || 11.5 <= I, u = 4 <= da(2) || 10 <= da(3), D, Q, U, X, ia, Ba, Sa, Ia, Ga, xa, Ka, h;
  })();
  (function() {
    function O(c) {
    ...
    fb && (Va.splice(1, 0, function() {
      for (var c = Xc(wb, "RichLink-sep"), n, u, D, Q, U, X; n = c.shift();) {
    ...
    if (Z && 0 > Ya.conpare(Za, "0.9.5")) {
      ...
      var K = fb ? function(c) {
        16 === c.keyCode ? oa = !0 : 9 === c.keyCode && ca && ma(ca, !0) && (ca.blur && ca.blur(), c.stopPropagation(), c.preventDefault(), ba(L));
      } : function(c) {
        16 === c.keyCode ? oa = !0 : 9 === c.keyCode && (ea = db());
      }, Ea = function(c) {
        16 === c.keyCode && (oa = !1);
      }, wa = fb ? function(c) {
        ...
        var u = db(), D = va, Q = "nextSibling", U = "firstChild";
        oa && (n || u - 99 < ea && ea <= u) && (Q = "previousSibling", U = "lastChild");
        for (ha = v; c !== D;) {
          if (X) {
            u = c;
            var X = !1;
  ...
  (function() {
    ...
    function ea(d, k, E) {
      ...
      if (fa) {
        ...
        if (k !== v) {
          ...
          d = Xa + E;
          if (Bb || Mb) {
            return Ua <= E ? (k = ta, K("4.1.1")) : Bb ? (k = gc - E, K("4.1.2")) : (k = ta + E - Ua, K("4.1.3")), ka = v, Y.scroll(0, k), K("4.1.*"), S;
          }
    ...
    function ca(d) {
      if (Lb) {
        ...
        if (zb(G, E)) {
          ...
          h ? (S = [V, d], qa && Eb(qa), qa = ba(P, 7, 1 > Z || 536 > sa || 14 > Da ? 500 : 0)) : (t = lc(), ea(v, V, d));
          T(V, d);
        }
      }
    }
    ...
    function aa() {
      N.fullscreenElement || N.fullscreen || N.webkitIsFullscreen || N.msFullscreenElement || Y.fullScreen ? (sb(za, "id", "blog2slide-root"), Ob[1].parentNode.insertBefore(Ja, Ob[1]), pa(), N.onkeydown = a) : hb && ($a(Ja), mb(za, "id"), mb(hb, "id"), hb = N.onkeydown = v);
    }
    function pa() {
      hb && mb(hb, "id");
    ...
    var b = Z && 0 > Ya.conpare(Za, "0.9.1"), m = 11 <= B || jb || 9 <= I && 9.5 > I, A = 11 > B, c = 7.2 <= I && 7.5 > I, n = 9 > Z && !b || 19 > Da || 4.3 > kb || 2 > Xb || 536 > sa || 6 > Ca || 7 <= I && 9 > I && !c, u = !b && !m && !A && !c && !n, D = u ? function(d, k, E) {
      ...
      d.href = k;
      function bz() {
        "complete" === d.readyState && (ba(E, Q(G, V)), G = null, d.V = ib);
      }
      bz = !1;
      ...
      function fa() {
        Q(G, V) ? (G = null, ba(E, !0)) : db() < Xa ? ba(fa, 0, 99) : (G = null, ba(E, !1));
      }
    ...
    var Ka = ["jsSidebarFixer1", "jsSidebarFixer2"], h = !(9 > B || I || 1 <= Z && 1.3 > Z || Sc), e = !(5 > Ca || 2.2 > kb || 6 > da(12) || Pa(30) && 534 > sa || Pa(32) || 7 > B || 9 > I || 1 > Z), w = e || 6 === B || 1 > Z, r = 7.5 > I, q, l, J, z = nd && Lc, M = 0, t = 0, F, S, ka, qa;
    hd || Hc || (Hb(function(d) {
      if (d) {
        if (!wb) {
          return !0;
    ...
    eb(function() {
      ...
      if (d) {
        ...
        R = d.requestFullscreen || d.webkitRequestFullscreen || d.mozRequestFullscreen || d.msRequestFullscreen;
        0 !== k || R ? (d.innerHTML = '<button class="btn">\u30b9\u30e9\u30a4\u30c9\u3092\u958b\u59cb\u3059\u308b</button>', la(d.firstChild, "click", L), d = Qa(d), za = Qa(d), Ob = yb(d, "section"), Ja = N.createElement("h1"), Ja.innerHTML = yb(va, "h1")[0].innerHTML, Cc = Ob.length, Ob.splice(0, 0, Ja), 0 !== k ? la(N, k + "ullscreenchange", aa) : B ? la(N, "MSFullscreenChange", aa, !1) : vc(aa)) : $a(d);
      }
    });
  })();
  ...
  (function() {
    ...
    function ha() {
      ...
      if (z) {
        ...
        if (F) {
          ...
          Ta || (b !== e ? P(Q, v, 2) : P(ha, v, 2));
        } else {
          J.push(l + q, t), P(ha, v, 2);
        }
      } else {
        e.l ? (b = e.l.h.shift()) ? P(Q, v, 2) : (b = e.l, P(ha, v, 2)) : P(Sa, v, 2);
      }
    }
    function ca(h) {
      if (U.length) {
    ...
    var X = function(h) {
      ...
      U.length ? P(ca, h, 2) : (r.m ? r.l && (r.l.h[0].m = q) : r.m = q, P(Q, v, 1));
    };
    var ia = function(h, e) {
      function w(M) {
        var t = M.nodeType;
    ...
    var Ba = function(h, e, w) {
      function r(t) {
        ...
        if (1 === F && !nb(t, "nocode")) {
          ...
          var S = t.nodeValue, ka = S.indexOf("\r\n"), qa = 2;
          -1 === ka && (ka = S.indexOf("\n"), qa = 1);
          -1 === ka && (ka = S.indexOf("\r"));
          -1 !== ka && (F = S.substr(0, ka), t.nodeValue = F, (S = S.substr(ka + qa)) && tc(t, S), q(t), F || $a(t));
        }
      }
      function q(t) {
        function F(ka, qa) {
        ...
        t = F(t.nextSibling, 0);
        for (var S; (S = t.parentNode) && 1 === S.nodeType;) {
          t = S;
        }
        J.push(t);
      }
    ...
    var Sa = function() {
      ...
      var F, S;
      for (S = F = 0; S < M;) {
        z[S] !== z[S + 2] ? (z[F++] = z[S++], z[F++] = z[S++]) : S += 2;
      }
      M = F;
      for (S = F = 0; S < M;) {
        var ka = z[S], qa = z[S + 1];
        for (S += 2; S + 2 <= M && z[S + 1] === qa;) {
          S += 2;
        }
        z[F++] = ka;
        z[F++] = qa;
      ...
      for (; J < l;) {
        ...
        qa = q[J + 1];
        var Ta;
        if (1 !== qa.nodeType && (Ta = e.substring(r, S))) {
          9 > B && (Ta = Ta.split("\n").join("\r"));
          var Ma = Rb(qa, "span", {className:ma[z[t + 1]]}, Ta);
          $a(qa);
          r < F && (q[J + 1] = tc(Ma, e.substring(S, F)));
        }
        r = S;
        r >= F && (J += 2);
        r >= ka && (t += 2);
          ...
          if (nb(e, "prettyprint") && !nb(e, "prettyprinted")) {
            ...
            if (!w) {
              ...
              if (!r) {
                ...
                var l;
                !r && (l = na(e)) && "CODE" === ab(l) && (r = h(l.className, "lang-") || h(l.className, "language-"));
              }
              q = ab(e);
              ...
              aa.codeBlocks.push({elm:e, lang:r, readyTime:T() - pa, decorateTime:0, decorateCount:0, updateDOMTime:0});
              P(D);
              return;
            }
          }
