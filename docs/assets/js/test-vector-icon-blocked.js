...
(function(Wa, Z, fb, Ic, M, mc, md, $b, rb, nc, oc, Jc, pc, v) {
  ...
  (function() {
    ...
    Xa.splice(0, 0, function() {
      ...
      yc(zb, "nojs");
      Bb = Db("jsMain");
      var d = !(8 > D || 5 > y || Jb || ib), n = Sc, t = 7 > y, B = ["og:", "twitter:", "fb:"], J = [], V = [], R = {};
      a(zb);
    });
  })();
  (function() {
    ...
    hd = function(g, k) {
      if (n) {
        ...
        for (var w = R, q = 0, F = w.length; q < F; q += 2) {
          if (w[q] === g && w[q + 1] === k) {
            w.splice(q, 2);
            w.length || (J ? la = Wc(la) : (B || V) && Pa(M, "focus", ba, !0));
            break;
          }
        }
      }
    ...
    l = 60 > Y || Cb;
    if (89 <= Y || 89 <= za || Kb && 79 <= Mc || T && (T("(forced-colors:none)").matches || T("(forced-colors:active)").matches)) {
  ...
  (function() {
    ...
    }, t, B, J, V, R, ba, la, e, b, c, m, l, u, h, C, r, O, x, A, Q, oa, ta, Ha, Ta, hb, Ua, Pb, vb, wb, g, k, w, q, F, ia, pa, eb, Fc;
    ...
    db(function() {
      ...
      if (Bb) {
        for (var p = Eb(Bb, "blockquote"), G, I = -1, da, z; G = p[++I];) {
    ...
    db(function() {
      ...
      if (f) {
        ...
        0 !== p || w ? (f.innerHTML = '<button class="btn">\u30b9\u30e9\u30a4\u30c9\u3092\u958b\u59cb\u3059\u308b</button>', ja(f.firstChild, "click", ha), f = Oa(f), q = Oa(f), pa = Eb(f, "section"), F = M.createElement("h1"), F.innerHTML = Eb(ra, "h1")[0].innerHTML, Fc = pa.length, pa.splice(0, 0, F), 0 !== p ? ja(M, p + "ullscreenchange", U) : y ? ja(M, "MSFullscreenChange", U, !1) : zc(U)) : Ra(f);
      }
    });
  })();
  Zb = !Ic || .9 > Y || 8 > D || 5.5 > y;
