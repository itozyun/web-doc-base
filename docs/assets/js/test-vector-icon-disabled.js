...
(function(Xa, W, hb, Gc, N, ic, jd, Wb, pb, jc, kc, Hc, lc, v) {
  ...
  (function() {
    ...
    function Q(e) {
      ...
      N.fonts.load(t).then(function(q) {
        ...
        (q = fa(U)) ? ia(I, q) : (D("[webFontTest] mesureWebFont() : false"), da(!0));
      }, function(q) {
    ...
    function da(e) {
      ...
      (e = fa(U, Ma)) ? (D("[webFontTest] testWebFont mesurement success : " + e), I(e)) : ma(Ma) ? (D("[webFontTest] testWebFont timeout!"), Da ? la() : Fa ? I(0) : qb !== v ? aa(qb) : pc(aa)) : ia(da);
    }
    function fa(e, t) {
      var q = 0, u = -1, h = pa && [];
      if (!k) {
      ...
      Za(ra);
      5 > B && (ra = v);
      t && (h || (q ? D("[webFontTest] " + e + ", " + L + "=" + H) : ma(t)));
      return q;
    }
    function aa(e) {
      D("[webFontTest] onTestDataURIComplete : " + e);
      e ? (Da = !0, Ma = K, D("[webFontTest] webFontTest_repeatToTestDataURIedCSSWebFont start!"), la()) : I(0);
    }
    function la() {
      if (T) {
        for (; T.length;) {
    ...
    Pc = function(e, t, q, u, h, L, w) {
      ...
      ca(10) ? ia(I, 1) : qc ? ia(I, 0) : !N.fonts || 603 > ta || 11 > Ha ? (D("[webFontTest] No native font loader."), da(!0)) : (D("[webFontTest] Use Native font loader."), Q(U));
    };
  ...
  (function() {
              ...
              if (M = X.N) {
                ...
                if (X.M) {
                  ...
                  if (2 === X.M) {
                    ...
                    na = M.length;
                    if (ea = M[na - 1]) {
                      (A = pb(ea.substr(1))) && ea === "s" + A ? M[na - 1] = "w" + F : M[na] = "w" + F;
                    }
                    M = M.join("=");
                  } else {
                    M = M.split("/");
                    na = M.length;
                    if (ea = M[na - 2]) {
                      (A = pb(ea.substr(1))) && ea === "s" + A ? M[na - 2] = "w" + F : M.splice(na - 1, 0, "w" + F);
                    }
                    M = M.join("/");
                  }
                }
    ...
    function da(d, m, F) {
      ...
      var ea = E, A = L, X = h.offsetTop === A.offsetTop, ba = 0, na = "", gb = !0;
      if (X) {
    ...
    var b = Y && 0 > Xa.conpare(Ya, "0.9.1"), l = 11 <= B || ib || 9 <= G && 9.5 > G, C = 11 > B, c = 7.2 <= G && 7.5 > G, n = 26 > Y && !b || 19 > za || 4.3 > jb || 2 > Yb || 536 > ta || 6 > Ha || 7 <= G && 9 > G && !c, r = !b && !l && !C && !c && !n, z, U = r ? function(d, m, F) {
      ...
      d.href = m;
      function bz() {
        "complete" === d.readyState && (F(T(M)), d.V = hb, z = null);
      }
      bz = !1;
      ...
      function A() {
        T(M) ? (F(!0), z = null) : cb() < ba ? ia(A, 0, 99) : (F(!1), z = null);
      }
      var X = new Image(), ba;
    ...
    db(function() {
      function d(X, ba, na, gb) {
        ...
        na = gb ? Sb(tc(F), Aa, {className:na}) : qa(F, Aa, {className:na});
